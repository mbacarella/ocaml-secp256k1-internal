...
//Requires: call_wasm
function ml_secp256k1_fe_storage_const_bytecode (r, d7, d6, d5, d4, d3, d2, d1, d0) {
...
function ml_secp256k1_gej_of_fields (r, x, y, z, infinity) {
    ...
    call_wasm("_secp256k1_gej_of_fields",r, x,
                          y, z,
                          !!infinity);
    return 0;
}
...
function ml_secp256k1_eckey_pubkey_serialize(elem, pub, size, compressed) {
    ...
    var r = call_wasm("_secp256k1_eckey_pubkey_serialize",elem, pub, size_ba, !!compressed);
